...
if tx == "1":
    ...
    def block_classic() :
            ...
            while True :
                ...
                try :
                    op = input("Введите операцию (1)+, 2)-, 3)*, 4)/, 5)n!, 6)2√, 7)3√, 8)**, 9)НОД, 10)НОК, 11)ost, 12)//, 13)!n, 14) log, 15) log x к y, 16) a⇈b (тетрация): ")
                    if op == "6" :
                        print(sqrt(num1))
                    elif op == "7" :
                        print(cbrt(num1))
    ...
    def block_classic() :
        ...
        while True :
                ...
                op = input("Enter the operation 1)+, 2)-, 3)*, 4)/, 5)n!, 6)2√, 7)3√, 8)**, 9)НОД, 10)НОК, 11)ost, 12)//, 13)!n, 14) log, 15) log x к y, 16) a⇈b (тетрация): ")
                if op == "6" :
                    print(sqrt(num1))
                elif op == "7" :
                    print(cbrt(num1))
