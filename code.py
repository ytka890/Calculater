while True:
    ...
    if tx == "1":
                        ...
                        if operation in ["sin", "cos", "tan", "cot", "sec", "csc"]:
                            ...
                            if gr.lower() == "degrees":
                                if result_rad is not None:
                                    ...
                                    print(f"{operation}({num})" if not isinstance(num,
                                                                                  (int, float)) else f"{operation}({num})",
                                          "=", f"{display_value_deg:.6f}° (в градусах)", sep=" ")
                            else:
                                if result_rad is not None:
                                    print(f"{operation}({num})" if not isinstance(num,
                                                                                  (int, float)) else f"{operation}({num})",
                                          "=", f"{result_rad:.6f} рад (в радианах)", sep=" ")
                        else:
        ...
        def block_classic():
            ...
            while True:
                ...
                try:
                    op = input(
                        "Введите операцию (1)+, 2)-, 3)*, 4)/, 5)n!, 6)2√, 7)3√, 8)**, 9)НОД, 10)НОК, 11)ost, 12)//, 13)!n, 14) log, 15) log x к y, 16) a⇈b (тетрация), 17)a**2 - b**2: ")
                    if op == "6":
                        print(sqrt(num1))
                    elif op == "7":
                        print(cbrt(num1))
                        ...
                        if op == '1':
                            ...
                            print(f"{num1} ** 2 - {num2} ** 2 = ({num1} - {num2}) * ({num1} + {num2}) =",
                                  (num1 - num2) * (num1 + num2))
                        elif op == '3':
                            print(num1 * num2)
                        elif op == '8':
        ...
        def block_square():
            while True:
                ...
                if op == "1":
                    ...
                    op4 = input(
                        "1)равносторонний, 2)равнобедренный или остроугольного или тупоугольного или разносторонний, 3)прямоугольный: ")
                    if op4 == "2":
                        try:
                    ...
                    if op3 == "1":
                        ...
                        try:
                            ...
                            if num3.lower() == "pi":
                                ...
                                num3 = float(num3)
                                print("S параллелограмма =", 0.5 * num1 * num2 * (sin(radians(num3))))
                        except ValueError:
                            print("Ошибка! Некорректный ввод первого числа.")
                            break
                        else:
        ...
        def block_addition():
            while True:
                try:
                    op3 = input(
                        "Выберите операцию: 1) x̄ - (среднее арифметическое)  2) |a| (модуль)  3) противоположное число  4) n√: ")
                except ValueError:
        ...
        def block_classic():
            ...
            while True:
                ...
                op = input(
                    "Enter the operation 1)+, 2)-, 3)*, 4)/, 5)n!, 6)2√, 7)3√, 8)**, 9)НОД, 10)НОК, 11)ost, 12)//, 13)!n, 14) log, 15) log x к y, 16) a⇈b (тетрация), 17)a**2 - b**2: ")
                if op == "6":
                    print(sqrt(num1))
                elif op == "7":
                    print(cbrt(num1))
    ...
    print('Выберете функцию из списка/Select a function from the list')
